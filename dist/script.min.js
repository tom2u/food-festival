import("./vendor/bootstrap.js"),
  $(document).ready(function () {
      ...
      function a(a) {
        return a.map((a) =>
          t(
            ...
            t("h5", { class: "card-title" }, a.title || ""),
            t("p", { class: "card-text" }, a.description || e()),
            t("hr")
          )
        );
      }
        ...
        o = t(
          ...
          t(
            ...
            t(
              "div",
              { class: "card-body" },
              t("h1", { class: "card-title" }, a.title || ""),
              t("h2", { class: "text-muted" }, a.subtitle || ""),
              t("p", { class: "card-text mt-3" }, a.description || e(100)),
              t(
                "a",
    ...
    if (
      ...
      const e = document.getElementById("purchaseBtn"),
